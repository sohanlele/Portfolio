  ...
  return (
    <div className="min-h-screen bg-[#f7f6f3] pt-24 pb-20 md:pt-28 md:pb-24">
      <div className="max-w-2xl mx-auto px-5 sm:px-8">
        ...
        <p className="mt-8 text-[16px] md:text-[18px] leading-[1.7] text-[#374151] mb-10">
        ...
        <div className="flex gap-8 items-center">
          <a
            ...
            className="text-[#166534] hover:underline transition-colors"
            aria-label="Email"
          >
          ...
          <a
            href="https://www.linkedin.com/in/sohanlele"
            target="_blank"
